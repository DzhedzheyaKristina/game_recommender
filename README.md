...
- не публикуйте `.env`;
- не публикуйте API-ключи, токены и сертификаты;
- не публикуйте сырой датасет;
- не публикуйте крупные generated CSV без отдельной необходимости;
- перед публикацией проверьте `git status` и содержимое `data/raw/`.
